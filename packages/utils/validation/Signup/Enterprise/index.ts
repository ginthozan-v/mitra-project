 ...
 */
import { EnterpriseUserData, Errors, EnterpriseUserDataErrors } from "../../types"

const validateCompanyName = (values: EnterpriseUserData) => {
    const errors: EnterpriseUserDataErrors = {};
...
const validateBusinessRegNumber = (values: EnterpriseUserData) => {
    const errors: EnterpriseUserDataErrors = {};
...
const validateCompanyAddress = (values: EnterpriseUserData) => {
    const errors: EnterpriseUserDataErrors = {};
...
const validateCountry = (values: EnterpriseUserData) => {
    const errors: EnterpriseUserDataErrors = {};
    if (!values.country) {
...
const validateFirstName = (values: EnterpriseUserData) => {
    const errors: EnterpriseUserDataErrors = {};
    if (!values.firstName) {
...
const validateLastName = (values: EnterpriseUserData) => {
    const errors: EnterpriseUserDataErrors = {};
    if (!values.lastName) {
...
const validateIDPassort = (values: EnterpriseUserData) => {
    const errors: EnterpriseUserDataErrors = {};
...
const validateDesignation = (values: EnterpriseUserData) => {
    const errors: EnterpriseUserDataErrors = {};
...
const validateMobileNumber = (values: EnterpriseUserData) => {
    const errors: EnterpriseUserDataErrors = {};
...
const validateIDPassortUpload = (values: EnterpriseUserData) => {
    const errors: EnterpriseUserDataErrors = {};
...
const validateAddressProof = (values: EnterpriseUserData) => {
    const errors: EnterpriseUserDataErrors = {};
...
const validateBusinessRegCertificate = (values: EnterpriseUserData) => {
    const errors: EnterpriseUserDataErrors = {};
...
const validateVAT = (values: EnterpriseUserData) => {
    const errors: EnterpriseUserDataErrors = {};
...
const validateIncorporation = (values: EnterpriseUserData) => {
    const errors: EnterpriseUserDataErrors = {};
...
const validateAdditionalFirstName = (values: EnterpriseUserData) => {
...
const validateAdditionalLastName = (values: EnterpriseUserData) => {
    const errors: EnterpriseUserDataErrors = {};
...
const validateAdditionalIDPassort = (values: EnterpriseUserData) => {
    const errors: EnterpriseUserDataErrors = {};
...
const validateAdditionalEmail = (values: EnterpriseUserData) => {
    const errors: EnterpriseUserDataErrors = {};
...
const validateAdditionalMobileNumber = (values: EnterpriseUserData) => {
    const errors: EnterpriseUserDataErrors = {};
