...
const ImageFileUpload = ({ name, value, accept, onChange, errors, touched, file, maxSize }: propType) => {
  ...
  return (
    <>
      {isOpen && (
        <Modal isOpen={isOpen} closeModal={closeModal} heading={modalContent?.title} content={modalContent?.message}>
