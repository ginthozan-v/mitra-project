...
const BillerIndividula = ({ data, download }) => {
  return (
    <div className='p-5 bg-white rounded-lg shadow'>
      ...
      <div className='flex items-start justify-between w-full p-5 mt-10 rounded-lg bg-gray-50'>
        <table className='text-gray-600'>
          <tbody>
            <tr className=''>
              <td className='px-3'>Billing Number</td>
            ...
            <tr>
              ...
              <td className='px-3'>{data?.currency?.symbol}</td>
            </tr>
          </tbody>
        </table>
          ...
          <table className='text-gray-600'>
            <tbody>
              ...
              <tr>
                ...
                <td className='px-3 font-bold text-gray-900'>
                  {Currency(data?.total, data?.currency?.code)}
                </td>
              </tr>
              {data.billingMode === 'ATB' && (
                <>
                  ...
                  <tr>
                    <td className='px-3 text-xl font-bold text-gray-900 '>
      ...
      <div className='mt-20'>
        <div className='relative overflow-x-auto'>
          <table className='w-full text-sm text-left text-gray-500 '>
            <thead className='text-xs text-gray-700 align-top whitespace-nowrap'>
              <tr>
                ...
                data?.billedProducts?.map((products, index) => (
                  <tr key={index} className='bg-white border-b'>
                    ...
                    <td className='px-3 py-2 whitespace-nowrap'>
                      {Currency(products?.unitPrice, data?.currency?.code)}
                    </td>
                    <td className='px-3 py-2 whitespace-nowrap'>
                      {Currency(products?.subTotal, data?.currency?.code)}
                    </td>
                  </tr>
                ))
              ) : (
...
export default BillerIndividula;
