...
export async function getServerSideProps({ params, locale }) {
  ...
  const res = await api.products.getAdvantages(subCategoryId, locale, true);

  const subCategoryData = res.map(
    ({ keywords, subCategoryId, productSubCategoryTitle, productSubCategoryCode, productSubCategoryShortDescription, banner, advantages }) => ({
      keywords,
      subCategoryId,
  ...
  return (
    <>
      ...
      <div className='content-wrapper'>
        <TabSet tabData={tabData} selectedTab={0} />
